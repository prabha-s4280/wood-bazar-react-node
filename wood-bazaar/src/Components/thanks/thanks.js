...
import './thanks.css'; // Include the CSS file for styling
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12 text-center pt-5">
            ...
            <p>
              <a href="/shop" className="btn btn-sm btn-outline">Back to shop</a>
            </p>
            <div className="papers">
              ...
              <div className="paper paper6"></div>
              <div className="paper paper7"></div>
              <div className="paper paper8"></div>
              <div className="paper paper1"></div>
              <div className="paper paper2"></div>
              <div className="paper paper3"></div>
              <div className="paper paper4"></div>
