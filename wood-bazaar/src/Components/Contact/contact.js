...
const Contact = () => {
  ...
  const [isSubmitted,setMessage]=useState(false);
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      setsubmittedName(formData.fname);
      setFormData({
        fname: '',
        lname: '',
        email: '',
            ...
            <div className="row justify-content-center">
              ...
              {isSubmitted ? (
                  <div className="thank-you-message">
                    ...
                    <h6 className='home-button' onClick={handleHomeClick} style={{ cursor: 'pointer', display:'inline-flex', alignItems:'center', color: 'blue'}}>
                  ...
                  <div className="col-lg-4">
                    ...
                    >
                      ...
                      <div className="service-contents">
                        <p>2-42 Korukonda Rd. Thirumalayapalem, Andhra Pradesh 533286</p>
                      </div>
                    </div>
                  </div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row">
                    <div className="col-6">
                      <div className="form-group">
                        <label className="text-black" htmlFor="fname">First name<span className='star'> *</span></label>
                        <input
                          type="text"
                    ...
                    <div className="col-6">
                      <div className="form-group">
                        <label className="text-black" htmlFor="lname">Last name<span className='star'> *</span></label>
                        <input
                          type="text"
                          className="form-control"
                          id="lname"
                  ...
                  <div className="form-group">
                    <label className="text-black" htmlFor="email">Email address<span className='star'> *</span></label>
                    <input
                      type="email"
                      className="form-control"
                      id="email"
